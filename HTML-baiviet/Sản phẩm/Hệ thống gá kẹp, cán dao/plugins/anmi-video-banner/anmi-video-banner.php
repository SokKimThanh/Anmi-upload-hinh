 ...
 * Description: Video banner với slider tự động + Admin CRUD panel - YouTube/Vimeo/MP4 support + Content Visibility Controls + Live Preview + Player Mode + Iframe Embed Support
 * Version: 1.6.0
...
define('ANMI_VIDEO_BANNER_VERSION', '1.6.0');
