...
## 2. Intent & Persona
- Intent: Problem-solution (bavia dính, phoi kẹt)
- Persona: Xưởng gia công nhôm, đồng, kim loại màu
- Pain: Phoi mềm dính vào rãnh → nóng, mất hiệu suất
- Outcome: Hiểu cơ chế rãnh rộng, chọn đúng ứng dụng

## 3. Keyword Map
| Type | Keyword | Volume | Note |
|------|---------|--------|------|
| Primary | aluminium cut carbide burr | mid (EN) | Việt hoá rõ “chống bám phoi” |
| Secondary | carbide burr cho nhôm | low | Section ứng dụng |
| Long-tail | xử lý phoi dính nhôm burr | low | FAQ |
| Semantic | chống bám / thoát phoi rộng | low | Body |

## 4. Meta
- Title: Carbide Burr Aluminium Cut: Giảm bám phoi khi gia công nhôm | AN MI TOOLS
- Meta desc: Aluminium Cut có rãnh sâu, rộng chống bám khi gia công nhôm & kim loại màu. Ứng dụng, so sánh với Double & Single Cut.
- Canonical: https://anmitools.com/carbide-burr/aluminium-cut/

## 5. Outline
1. Vấn đề: Phoi nhôm bết đầy rãnh
2. Aluminium Cut là gì – cấu trúc rãnh sâu/rộng
3. Cơ chế chống bám phoi
...
- Tập trung vào đặc tính kỹ thuật và ứng dụng thực tế của aluminium cut carbide burr
- Hướng dẫn liên hệ kỹ thuật cho tư vấn thông số cụ thể theo ứng dụng

### 14. CTA Architecture
| CTA Type | Copy | URL/Action | Placement |
|----------|------|-----------|-----------|
| Primary | Gửi vật liệu + tình trạng bám phoi → gợi ý cut | /contact-us/ | Sau So với Double |
