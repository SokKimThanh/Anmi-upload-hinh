...
\-   Codex: register\_post\_type() (developer.wordpress.org/reference/functions/register\_post\_type/)
...
\-   Codex: add\_meta\_box(), save\_post(), wp\_nonce\_field()
...
\-   Codex: wp\_handle\_upload() (developer.wordpress.org/reference/functions/wp\_handle\_upload/)
...
\-   Bài viết "Custom WordPress Queries with tax\_query"
...
\-   Codex: current\_user\_can() \& Roles (developer.wordpress.org/plugins/users/roles-and-capabilities/)
...
\-   Cache danh sách download qua set\_transient()/get\_transient()
